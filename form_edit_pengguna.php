			...
			<td>
                <center>
                    ...
                    <form action="aksi_update.php" method="POST">
                         <input type="int" name="id_pengguna" placeholder="" value="<?=$id;?>" readonly>
                        <br>
                        <br>
                        <input type="text" name="nama_pengguna" placeholder=""   value="<?=$nama;?>">
                        <br>
                        <br>
                        <input type="password" name="sandi_pengguna" placeholder="" value="<?=$sandi;?>">
                        <br><br>
